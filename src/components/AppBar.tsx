...
const AppBar = () => {
  return (
    <div className="flex justify-between bg-[#0f0f0f] text-white pt-1.5 ">
      <div className="text-xl font-bold tracking-tighter tracking-tight flex items-center pl-6">
        <div className="pr-5 pt-1 pl-0.6">
          <img
